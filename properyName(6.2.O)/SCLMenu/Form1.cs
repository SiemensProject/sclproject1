    ...
    public partial class Form1 : Form
    {
        ...
        private void BtnSelect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                name=sclFileExtractor.nameExtractor(FileToBeSearched);
            }
        ...
        private void btnJson_Click(object sender, EventArgs e)
        {
            ...
            {
                FileWriter writer = new FileWriter();
                writer.WriteJson(OutputFileLocation, "names1.json", LstEDc,name);
                MessageBox.Show("Created " + OutputFileLocation + "\\names1.json");
            }
            else
            {
                ...
                else
                {
                    ...
                    FileWriter writer = new FileWriter();
                    writer.WriteJson(OutputFileLocation, f, LstEDc,name);
                    MessageBox.Show("Created  " + OutputFileLocation + "\\" + f);
